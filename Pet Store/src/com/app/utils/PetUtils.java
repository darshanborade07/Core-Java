...
//		throw new OutOfStockException("no pets!!");
	...
	public static List<User> populatedUsersList(){
		List<User> usersList = new ArrayList<User>();
		usersList.add(new User("Admin", "Admin", Role.ADMIN));
		usersList.add(new User("c1", "c1", Role.CUSTOMER));
		usersList.add(new User("c2", "c2", Role.CUSTOMER));
